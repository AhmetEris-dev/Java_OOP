...
//	int uyeNo) {
		...
		Uye uye3=new Uye("Su","Kadıköy İstanbul","1999","18.07.2024","Akbaş","11122233346","5552221122");
		Uye uye4=new Uye("Su","Kadıköy İstanbul","1999","18.07.2024","Beyazit","11122233347","5552221122");
		Uye uye5=new Uye("Su","Kadıköy İstanbul","1999","18.07.2024","Yıldırım","11122233344","5552221122");
...
//		kutuphane1.kitaplariListele();
		...
		kutuphane1.uyelerListele();
		kutuphane1.uyeSil("11122233345");
		kutuphane1.uyelerListele();
		kutuphane1.uyeAra("su");
